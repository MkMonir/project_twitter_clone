...
var register = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(firstName, lastName, username, email, password, passwordConfirm) {
    var res;
...
if (registerForm) registerForm.addEventListener('submit', function (e) {
  ...
  (0, _register.register)(firstName, lastName, username, email, password, passwordConfirm);
});
